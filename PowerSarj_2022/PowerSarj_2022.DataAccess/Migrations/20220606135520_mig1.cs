    ...
    public partial class mig1 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "MARDEV_1", "MARSIS_ADMIN_1", null, new DateTime(2022, 6, 6, 16, 55, 19, 759, DateTimeKind.Local).AddTicks(471), "MARDEV_1", "MARSISBILISIM_DEVICE_1", "36.36 , 36.36", null, 0m, "WHITEROSE", null, "AC" });

            migrationBuilder.InsertData(
                table: "Devices",
                columns: new[] { "_id", "adminid", "charginguser", "date", "deviceid", "devicename", "location", "mobilecharging", "price", "site", "state", "type" },
                values: new object[] { "MARDEV_2", "MARSIS_ADMIN_2", null, new DateTime(2022, 6, 6, 16, 55, 19, 759, DateTimeKind.Local).AddTicks(4472), "MARDEV_2", "MARSISBILISIM_DEVICE_2", "36.37 , 36.37", null, 0m, "MAR-SİS BİLİSİM", null, "AC" });

            migrationBuilder.InsertData(
                table: "Devices",
                columns: new[] { "_id", "adminid", "charginguser", "date", "deviceid", "devicename", "location", "mobilecharging", "price", "site", "state", "type" },
                values: new object[] { "MARDEV_3", "MARSIS_ADMIN_2", null, new DateTime(2022, 6, 6, 16, 55, 19, 759, DateTimeKind.Local).AddTicks(4497), "MARDEV_3", "MARSISBILISIM_DEVICE_3", "36.37 , 36.37", null, 0m, "MAR-SİS BİLİSİM", null, "DC" });
